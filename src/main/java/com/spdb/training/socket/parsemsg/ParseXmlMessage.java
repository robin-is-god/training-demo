...
public class ParseXmlMessage extends AbsParseMessage {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("已解析成Map对象:" + readAssignMsg2Map);

			// map to javabean
			ReqOR01Service reqOR01Service = (ReqOR01Service) ReflectParseUtils.mapToObject((Map<String, Object>) readAssignMsg2Map.get("reqService"), ReqOR01Service.class);
			System.out.println("..：" + reqOR01Service.getBody().toString());
